	...
	- Deadly Dozen
		...
		3. Rely on one technique
			...
			* Pros & Cons of each Model
				a. Regression - Find which variables are important
		...
		5. Listen only to the data
			* Computer knows nothing about the world. 
...
Takeaways
	...
	- Be careful of common mistakes in building models. 
	...
	- Tips to avoid overfitting:
		...
		b. Randomize data before splitting. You want to represent the population and sometime the dataset is already ordered.
